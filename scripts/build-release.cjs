...
const dir=path.join(__dirname,'../gpt-sharp/releases/20260912-2');
...
fs.writeFileSync(path.join(dir,'release.json'),JSON.stringify({build:'20260912.2',scoringVersion:2,generatorVersion:2,dictionary:'common-checked-20260912',assets:hashes},null,2)+'\n');
